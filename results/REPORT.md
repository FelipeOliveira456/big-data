...
590 comunidades em todas as runs OK. Duas mega-comunidades cobrem **~91%** dos nós (46,8% + 44,7%). Top 10 = 98,7% dos nós. `converged=false` — normal no Orkut com 100 iter.

Com 3M+ nós, os JSON de partições **não incluem `node_ids`** (limite 50k) — não há visualização de grafo completo nos artefactos.
...
| `figures/performance_comparison.png` | Ray vs Dask (3 runs cada) |
